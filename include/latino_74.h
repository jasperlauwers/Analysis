...
// Mon Dec 21 18:38:15 2015 by ROOT version 5.34/18
// from TTree latino/probe_tree
// found on file: InTrees/eosTrees/21Oct_25ns_MC/mcwghtcount__MC__l2sel/latino_WpWpJJ_QCD.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("InTrees/eosTrees/21Oct_25ns_MC/mcwghtcount__MC__l2sel/latino_WpWpJJ_QCD.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("InTrees/eosTrees/21Oct_25ns_MC/mcwghtcount__MC__l2sel/latino_WpWpJJ_QCD.root");
      }
