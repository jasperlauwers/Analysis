...
// Mon Oct 12 15:25:09 2015 by ROOT version 5.34/18
// from TTree latino/probe_tree
// found on file: InTrees/latino_DYJetsToLL_M-50.root
//////////////////////////////////////////////////////////
...
//    Double_t        fCoordinates_fT;
   ...
   TBranch        *b_effBW;   //!
   TBranch        *b_effW;   //!
   TBranch        *b_eleIdLoose1;   //!
   TBranch        *b_eleIdMedium1;   //!
   TBranch        *b_eleIdTight1;   //!
   TBranch        *b_eleIdVeto1;   //!
   TBranch        *b_eta1;   //!
   TBranch        *b_eta2;   //!
   TBranch        *b_eta3;   //!
   TBranch        *b_eta4;   //!
...
#ifdef latino_cxx
latino::latino(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("InTrees/latino_DYJetsToLL_M-50.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("InTrees/latino_DYJetsToLL_M-50.root");
      }
...
Int_t latino::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t latino::LoadTree(Long64_t entry)
{
...
void latino::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("eleIdLoose1", &eleIdLoose1, &b_eleIdLoose1);
   fChain->SetBranchAddress("eleIdMedium1", &eleIdMedium1, &b_eleIdMedium1);
   fChain->SetBranchAddress("eleIdTight1", &eleIdTight1, &b_eleIdTight1);
   fChain->SetBranchAddress("eleIdVeto1", &eleIdVeto1, &b_eleIdVeto1);
...
void latino::Show(Long64_t entry)
{
...
Int_t latino::Cut(Long64_t entry)
{
