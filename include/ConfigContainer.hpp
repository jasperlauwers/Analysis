...
struct ConfigContainer {
    ...
    bool plotRatio, plotSignificance, logY, signalStacked, addOverflow, addUnderflow, drawUncertainty, drawNormalized, unblind, flipChargeDY, latinoFakes, trileptonFakes;
};
#endif