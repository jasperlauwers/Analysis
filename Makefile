...
all: testAnalysis Plot_cut_efficiency stackPlotter qcdScalePlotter fakeLepton multiplePlotter anomalousCoupling chargeFlipProbability tagJetEfficiency
...
obj/chargeFlipProbability.o: chargeFlipProbability.cpp EventReader.hpp TreeReader.hpp latino.h EventContainer.hpp Lepton.hpp Jet.hpp Met.hpp Particle.hpp VariableReader.hpp VariableContainer.hpp ConfigReader.hpp SampleReader.hpp SampleContainer.hpp CutReader.hpp CutContainer.hpp EventCleaner.hpp ConfigHandler.hpp  EventSelecter.hpp VariableDictionary.hpp ConfigContainer.hpp HistogramContainer.hpp LatinoStyle2.h

chargeFlipProbability : $(OBJ_FILES) obj/chargeFlipProbability.o obj/latino.o obj/LatinoStyle2.o
	$(CC) -o $@ $^ $(CFLAGS) $(CFLAGS_libconfig) $(LIBS) $(LIBS_libconfig)

obj/tagJetEfficiency.o: tagJetEfficiency.cpp EventReader.hpp TreeReader.hpp latino.h EventContainer.hpp Lepton.hpp Jet.hpp Met.hpp Particle.hpp VariableReader.hpp VariableContainer.hpp ConfigReader.hpp SampleReader.hpp SampleContainer.hpp CutReader.hpp CutContainer.hpp EventCleaner.hpp ConfigHandler.hpp  EventSelecter.hpp VariableDictionary.hpp ConfigContainer.hpp HistogramContainer.hpp LatinoStyle2.h

tagJetEfficiency : $(OBJ_FILES) obj/tagJetEfficiency.o obj/latino.o obj/LatinoStyle2.o
	$(CC) -o $@ $^ $(CFLAGS) $(CFLAGS_libconfig) $(LIBS) $(LIBS_libconfig)
